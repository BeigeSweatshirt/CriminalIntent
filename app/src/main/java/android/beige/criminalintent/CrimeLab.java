...
import android.beige.criminalintent.database.CrimeBaseHelper;
import android.beige.criminalintent.database.CrimeCursorWrapper;
import android.beige.criminalintent.database.CrimeDbSchema.CrimeTable;
...
public class CrimeLab {
    ...
    public Crime getCrime(UUID id) {
        CrimeCursorWrapper cursor = queryCrimes(
                CrimeTable.Columns.UUID + " = ?", new String[] { id.toString() });
